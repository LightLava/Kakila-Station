...
uplink-autosurgeon-statveka-sandevistan-desc = Заменяет сердце пользователя на «Статвека Сандевистан» — синтетический орган, который значительно повышает скорость и рефлексы пользователя за счёт выносливости. В отличие от обычного аналога, этот, по-видимому, замедляет время рядом с пользователем. Поставляется с одноразовым автохирургом для установки.
